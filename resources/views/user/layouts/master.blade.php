...
<body>
    ...
    <div class="container-fluid bg-dark mb-30">
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block  mt-2">
                <h3 class="h1 text-uppercase text-primary bg-dark px-2">Pizza Shop</h3>
            </div>
            <div class="col-lg-9">
    ...
    {{-- <script src="{{asset('user/mail/jqBootstrapValidation.min.j')}}s"></script>
