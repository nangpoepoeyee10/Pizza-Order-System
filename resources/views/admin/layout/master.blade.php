                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('admin#userList') }}">
                                <i class="fa-solid fa-list-check"></i>User Lists</a>
                        </li>
                        <li>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <h5 class="form-header" action="" method="POST" style="font-weight: bold">
                                {{-- <input class="au-input au-input--xl" type="text" name="search" placeholder="Search for datas &amp; reports..." />
                                <button class="au-btn--submit" type="submit">
                                    <i class="zmdi zmdi-search"></i>
                                </button> --}}
                                Admin Deshboard Panel
                            </h5>
                                            ...
                                            <div class="account-dropdown__footer my-3">
                                                <form action="{{ route('logout') }}" method="post"
                                                    ...
                                                    <button class="btn btn-dark text-white col-10" type="submit"><i
                                                            class="fa-solid fa-right-from-bracket m-2"></i>Logout</button>
                                                    {{-- <input type="submit" class="btn bg-dark text-white col-10" value="logout"> --}}
                                                </form>
                                            </div>
                                        </div>
                                    </div>
